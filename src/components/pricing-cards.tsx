                ...
                {PLANS.map((plan) => (
                    <Card
                        ...
                        className={cn(
                           ...
                           plan.name === "Pro" && "border-2 border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.6)]"

                        )}
                    >
                        <CardHeader className={cn(
                            "border-b border-border",
                            plan.name === "Pro" ? "bg-red-500/[0.07]" : "bg-foreground/[0.03]"
                        )}>
                        ...
                        <CardContent className="pt-6 space-y-4">
                            {plan.features.map((feature, index) => (
                                <div key={index} className="flex items-center gap-2">
                                    <CheckCircleIcon className="text-red-500 w-4 h-4" />
                                    <TooltipProvider>
                        ...
                        <CardFooter className="w-full mt-auto">
                            <Link
                                href={plan.btn.href}
                                style={{ width: "100%" }}
                                className={buttonVariants({ className: plan.name === "Pro" && "bg-red-500 hover:bg-red-500/80 text-white" })}
                            >
                                {plan.btn.text}
                            </Link>
                        </CardFooter>
                            ...
                            <h5 className="text-3xl font-semibold flex items-end">
                                ...
                                {plan.name !== "Free" && (
                                    <motion.span
                                        ...
                                        className="px-2 py-0.5 ml-2 rounded-md bg-red-500 text-foreground text-sm font-medium"
                                    >
                                        -12%
                                    </motion.span>
                                )}
