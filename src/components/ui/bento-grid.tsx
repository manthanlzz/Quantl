        ...
        background: (
            <Command className="absolute right-10 top-10 w-[70%] origin-to translate-x-0 border border-border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_40%,#000_100%)] group-hover:-translate-x-10 p-2">
                ...
                <div className="mt-1 cursor-pointer">
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Quantl.io/hdf00c</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Quantl.io/sdv0n0</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Quantl.io/03gndo</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Quantl.io/09vmmw</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Quantl.io/s09vws</div>
                    <div className="px-4 py-2 hover:bg-muted rounded-md">Quantl.io/sd8fv5</div>
                </div>
            </Command>
        ),
    },
